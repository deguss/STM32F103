...
enum minmea_sentence_id {
    MINMEA_INVALID = -1,
    MINMEA_UNKNOWN = 0,
    MINMEA_SENTENCE_GBS,	//1
    MINMEA_SENTENCE_GGA,	//2
    MINMEA_SENTENCE_GLL,	//3
    MINMEA_SENTENCE_GSA,	//4
    MINMEA_SENTENCE_GST,	//5
    MINMEA_SENTENCE_GSV,	//6
    MINMEA_SENTENCE_RMC,	//7
    MINMEA_SENTENCE_VTG,	//8
    MINMEA_SENTENCE_ZDA,	//9
};
